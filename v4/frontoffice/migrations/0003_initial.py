...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'frontoffice_countries', (
            ...
            ('langue', self.gf('django.db.models.fields.CharField')(max_length=15)),
        ...
        db.send_create_signal(u'frontoffice', ['Countries'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'frontoffice_countries')
    ...
    models = {
        ...
        u'frontoffice.countries': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'langue': ('django.db.models.fields.CharField', [], {'max_length': '15'}),

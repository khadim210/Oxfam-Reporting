...
class Operation(models.Model):
    ...
    somme_operation = models.IntegerField(default=0, verbose_name=_('Montant opération'))
    ...
    soumission = models.CharField(max_length=20, verbose_name=_("Etat soumission"), choices=etats_soumission, default=_('Brouillon'))
    ...
    type_operation = models.CharField(choices=op, max_length=20, verbose_name=_("Type d'opération"))
    opp = (
        (_('Virement'), 'Virement'),
        (_('Cheque'), 'Cheque')
    )
